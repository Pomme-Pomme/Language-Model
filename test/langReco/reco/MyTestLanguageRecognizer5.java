...
public class MyTestLanguageRecognizer5 {
	...
	public void testBaselineLanguageRecognizer() {
		...
		MyLanguageRecognizer3 baseline = new MyLanguageRecognizer3("lm/fichConfig_trigram-16000.txt");

		//On fait les calcul et on regarde les performances
		String hypLangFilePath = "/tmp/hyp";
		baseline.recognizeFileLanguage(goldSentPath, hypLangFilePath, 1);
